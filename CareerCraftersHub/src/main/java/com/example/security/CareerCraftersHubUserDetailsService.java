...
@Service
public class CareerCraftersHubUserDetailsService implements UserDetailsService {
    private UserRepository userRepository;

    private JwtUtil jwtUtil;

    @Autowired
    public CareerCraftersHubUserDetailsService(UserRepository userRepository, JwtUtil jwtUtil) {
