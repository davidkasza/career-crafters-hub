...
public class EmailService {
    ...
    public void sendEmail(UserDTO userDTO) throws MessagingException {
        ...
        try {
            message.setFrom("admin@careercrafters.com");
            ...
            String button = "<a href=\"" + configuration.getDomain() + "/api/verify-email?token=" + token + "\" style=\"background:#3630a3;color:white;\"" + ">" + "Verify email</a>";
